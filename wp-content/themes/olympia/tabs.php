...
<div id="newtabs" class="tabox ">
    <ul class="tabsnav">
        <li class="fea"><a href="#popular"> פופולארי </a></li>
		<li class="rec"><a href="#recent">  אחרונים </a></li>
		<li class="pop"><a href="#tgs">     מהמערכת    </a></li>
    </ul>
...
<h3><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php echo substr($post->post_title,0,80); ?></a></h3>
