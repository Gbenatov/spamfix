...
$options = array (
	...
	array(   "name" => "Enable Custom fonts?",
			 "desc" => "Select if you want to show use cufon generated fonts.",
      	     "id" => $shortname."_cufon",
     		 "type" => "checkbox",		
	  		 "std" => "true"),
			 
	array(   "name" => "Show homepage widgets",
			 "desc" => "Select if you want to show the homepage widgets.",
      	     "id" => $shortname."_homewidgets",
     		 "type" => "checkbox",		
	  		 "std" => "true"),		 
			 
				 
	array(   "name" => "Show twitter update",
			 "desc" => "Select if you want to show the twitter update on homepage.",
      	     "id" => $shortname."_showtwit",
     		 "type" => "checkbox",		
	  		 "std" => "true"),	


   	array(	"name" => "Welcome message ",
			"desc" => "Show a welcome message on the subheader area.",
